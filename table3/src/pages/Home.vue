<template lang="">
    <div class="HomePage">
        ...
        <div class="conBox">
            ...
            <div class="buttonBox">
                <div class="btn animate__animated cursorPointer" v-for="(btn, index) in buttons" :key="index" :class="getAnimationClass(index)" @click="router.push({ path: '/Introduction', query: { type: index }})">
...
<script setup>
    ...
    // const buttons = ref([{'eng':'IDEATION','china':'主意'},{'eng':'INCUBATION','china':'培育'},{'eng':'ACCELERATION','china':'加速'},{'eng':'ELITE','china':'精英'}])
    const buttons = ref([{'eng':'IDEATION','china':'IDEATION'},{'eng':'INCUBATION','china':'INCUBATION'},{'eng':'ACCELERATION','china':'ACCELERATION'},{'eng':'ELITE','china':'ELITE'}])
