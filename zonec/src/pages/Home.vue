...
<script setup>
    ...
    const buttons = ref([{'eng':'STARTUPS<br>INVOLVEMENT','china':'投入創科生態園'},{'eng':'MENTORSHIP','china':'導師計劃'},{'eng':'ALUMNI','china':'香港科學園創科會'}])

    const getAnimationClass = (index) => {
        const animations = ['animate__fadeInLeft clothing', 'animate__fadeInRight food', 'animate__fadeInUp housing']
